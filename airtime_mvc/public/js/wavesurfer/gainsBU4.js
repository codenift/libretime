...
var Gain = /*#__PURE__*/function () {
  ...
  _createClass(Gain, [{
    ...
    value: function render() {
      ...
      if (this.resize) {
        this.handleLeftEl = gainEl.appendChild(document.createElement('handle'));
        this.handleRightEl = gainEl.appendChild(document.createElement('handle'));
    ...
    value: function updateRender() {
      ...
      if (this.element != null) {
        // Calculate the left and width values of the gain such that
        // no gaps appear between gains.
        var left = Math.round(startLimited / dur * width);
        var gainWidth = Math.round(endLimited / dur * width) - left;
